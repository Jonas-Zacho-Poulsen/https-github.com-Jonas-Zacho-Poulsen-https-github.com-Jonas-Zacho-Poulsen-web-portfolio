...
const predefinedResponses = {
  ...
  skills: `Jonas' Key Technical Skills:
  ...
  - AI Chat Application (React, OpenAI, WebSocket)
  - E-commerce Platform (Next.js, tRPC, Prisma)
...
export function AIChat() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Get LLM response
    const aiResponseText = await getLLMResponse(userMessage.text);
    ...
    const aiResponse: Message = {
      ...
      sender: "ai",
      timestamp: new Date(),
      topic: "default" // You might need a more sophisticated way to determine the topic
    }
                ...
                >
                  ...
                  >
                    {typeof message.text === 'string' ? (
                      ...
                      <span>Error: Invalid message format</span>
                    )}
                  </div>
                </motion.div>
              ))}
